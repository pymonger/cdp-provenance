...
public class Annotation extends Entity {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@31feed has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@31feed has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
