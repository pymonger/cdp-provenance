...
public class WasDerivedFrom extends Edge {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@2f1e6e7f has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@2f1e6e7f has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public void removeAllCauseWasDerivedFrom() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@134a388b has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@134a388b has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
