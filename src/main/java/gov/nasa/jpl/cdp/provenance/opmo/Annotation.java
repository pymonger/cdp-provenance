...
public class Annotation extends Entity {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://openprovenance.org/model/opmo#Annotation", false);

    /** http://openprovenance.org/model/opmo#property */
	public static final URI PROPERTY = new URIImpl("http://openprovenance.org/model/opmo#property",false);
    ...
    public static final URI[] MANAGED_URIS = {
      new URIImpl("http://openprovenance.org/model/opmo#property",false) 
    };
	 ...
	 */
	protected Annotation ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Annotation ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public Annotation ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public Annotation ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public Annotation ( Model model, boolean write ) {
	 ...
	 * @return an instance of Annotation  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static Annotation  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Annotation.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://openprovenance.org/model/opmo#Annotation).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
    ...
    /**
	 * Remove rdf:type Annotation from this instance. Other triples are not affected.
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Annotation' to this Annotation instance
	 *
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllAnnotation_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, Annotable.ANNOTATION, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllAnnotation_Inverse() {
		return Base.getAll_Inverse(this.model, Annotable.ANNOTATION, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'Annotation' to this Annotation instance
	 *
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllAnnotation_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, Annotable.ANNOTATION, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}



    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@43277a30 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@43277a30 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public static boolean hasProperty(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, org.ontoware.rdf2go.model.node.Node value ) {
		return Base.hasValue(model, instanceResource, PROPERTY, value);
	}
	...
	public boolean hasProperty( org.ontoware.rdf2go.model.node.Node value ) {
		return Base.hasValue(this.model, this.getResource(), PROPERTY, value);
	}
     ...
     */
	public static ClosableIterator<Property> getAllProperty(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, PROPERTY, Property.class);
	}
	
    /**
     * Get all values of property Property as a ReactorResult of Property 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ReactorResult<Property> getAllProperty_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, PROPERTY, Property.class);
	}
     ...
     */
	public ClosableIterator<Property> getAllProperty() {
		return Base.getAll(this.model, this.getResource(), PROPERTY, Property.class);
	}
     ...
     */
	public ReactorResult<Property> getAllProperty_as() {
		return Base.getAll_as(this.model, this.getResource(), PROPERTY, Property.class);
	}
    ...
    /**
     * Adds a value to property Property from an instance of Property 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 *
	 * [Generated from RDFReactor template rule #add3static] 
     */
	public static void addProperty(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Property value) {
		Base.add(model, instanceResource, PROPERTY, value);
	}
    ...
    /**
     * Sets a value of property Property from an instance of Property 
     * First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with
     * no minCardinality or minCardinality == 1.
     * @param model an RDF2Go model
     ...
     */
	public static void setProperty(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Property value) {
		Base.set(model, instanceResource, PROPERTY, value);
	}
    ...
    /**
     * Removes a value of property Property given as an instance of Property 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be removed
	 *
     ...
     */
	public static void removeProperty(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, Property value) {
		Base.remove(model, instanceResource, PROPERTY, value);
	}
