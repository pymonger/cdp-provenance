 ...
 */
public class Location extends A_1 {

    /** http://www.w3.org/ns/prov#Location */
	@SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://www.w3.org/ns/prov#Location", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/ns/prov#Location).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'AtLocation' to this Location instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse1static] 
	 */
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllAtLocation_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, A_1.ATLOCATION, objectValue);
	}
	 ...
	 */
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllAtLocation_Inverse() {
		return Base.getAll_Inverse(this.model, A_1.ATLOCATION, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'AtLocation' to this Location instance
	 *
	 * [Generated from RDFReactor template rule #getallinverse-as1static] 
	 */
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllAtLocation_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, A_1.ATLOCATION, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}
