...
public class Entity extends A_1 {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://openprovenance.org/model/opmo#Entity", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://openprovenance.org/model/opmo#Entity).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
