 ...
 */
public class EventEdge extends Entity {

    /** http://openprovenance.org/model/opmo#EventEdge */
	@SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://openprovenance.org/model/opmo#EventEdge", false);

    /** http://openprovenance.org/model/opmo#time */
	public static final URI TIME = new URIImpl("http://openprovenance.org/model/opmo#time",false);
    ...
    public static final URI[] MANAGED_URIS = {
      new URIImpl("http://openprovenance.org/model/opmo#time",false) 
    };
	 ...
	 */
	protected EventEdge ( Model model, URI classURI, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public EventEdge ( Model model, org.ontoware.rdf2go.model.node.Resource instanceIdentifier, boolean write ) {
	 ...
	 */
	public EventEdge ( Model model, String uriString, boolean write) throws ModelRuntimeException {
	 ...
	 */
	public EventEdge ( Model model, BlankNode bnode, boolean write ) {
	 ...
	 */
	public EventEdge ( Model model, boolean write ) {
	 ...
	 * @return an instance of EventEdge  or null if none existst
	 *
	 * [Generated from RDFReactor template rule #class0] 
	 */
	public static EventEdge  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, EventEdge.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://openprovenance.org/model/opmo#EventEdge).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends EventEdge> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, EventEdge.class );
	}

    /**
	 * Remove rdf:type EventEdge from this instance. Other triples are not affected.
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@724a2dd4 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@724a2dd4 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public static boolean hasTime(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, org.ontoware.rdf2go.model.node.Node value ) {
		return Base.hasValue(model, instanceResource, TIME, value);
	}
	...
	public boolean hasTime( org.ontoware.rdf2go.model.node.Node value ) {
		return Base.hasValue(this.model, this.getResource(), TIME, value);
	}
     ...
     */
	public static ClosableIterator<OTime> getAllTime(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll(model, instanceResource, TIME, OTime.class);
	}
	
    /**
     * Get all values of property Time as a ReactorResult of OTime 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     ...
     */
	public static ReactorResult<OTime> getAllTime_as(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getAll_as(model, instanceResource, TIME, OTime.class);
	}
     ...
     */
	public ClosableIterator<OTime> getAllTime() {
		return Base.getAll(this.model, this.getResource(), TIME, OTime.class);
	}
     ...
     */
	public ReactorResult<OTime> getAllTime_as() {
		return Base.getAll_as(this.model, this.getResource(), TIME, OTime.class);
	}
    ...
    /**
     * Adds a value to property Time from an instance of OTime 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 *
	 * [Generated from RDFReactor template rule #add3static] 
     */
	public static void addTime(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, OTime value) {
		Base.add(model, instanceResource, TIME, value);
	}
     ...
     */
	public void addTime(OTime value) {
		Base.add(this.model, this.getResource(), TIME, value);
	}
    ...
    /**
     * Sets a value of property Time from an instance of OTime 
     * First, all existing values are removed, then this value is added.
     * Cardinality constraints are not checked, but this method exists only for properties with
     * no minCardinality or minCardinality == 1.
     * @param model an RDF2Go model
     ...
     */
	public static void setTime(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, OTime value) {
		Base.set(model, instanceResource, TIME, value);
	}
    ...
    /**
     * Removes a value of property Time given as an instance of OTime 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be removed
	 *
     ...
     */
	public static void removeTime(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource, OTime value) {
		Base.remove(model, instanceResource, TIME, value);
	}
     ...
     */
	public void removeTime(OTime value) {
		Base.remove(this.model, this.getResource(), TIME, value);
	}
