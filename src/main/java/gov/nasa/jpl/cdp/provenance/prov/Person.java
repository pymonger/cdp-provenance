...
public class Person extends Agent {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://www.w3.org/ns/prov#Person", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://www.w3.org/ns/prov#Person).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
