...
public class EventEdge extends Entity {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@71aeb3 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@71aeb3 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
