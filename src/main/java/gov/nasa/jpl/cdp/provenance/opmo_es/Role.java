...
public class Role extends Entity {
	...
	public static final URI RDFS_CLASS = new URIImpl("http://openprovenance.org/model/opmo#Role", false);
	 ...
	 * That is, create the statement (instanceResource, RDF.type, http://openprovenance.org/model/opmo#Role).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as RDF resources, that have a relation 'Role' to this Role instance
	 *
	...
	public static ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllRole_Inverse( Model model, Object objectValue) {
		return Base.getAll_Inverse(model, A_1.ROLE, objectValue);
	}
	...
	public ClosableIterator<org.ontoware.rdf2go.model.node.Resource> getAllRole_Inverse() {
		return Base.getAll_Inverse(this.model, A_1.ROLE, this.getResource() );
	}

	/**
	 * @param model an RDF2Go model
	 * @param objectValue
	 * @return all A's as a ReactorResult, that have a relation 'Role' to this Role instance
	 *
	...
	public static ReactorResult<org.ontoware.rdf2go.model.node.Resource> getAllRole_Inverse_as( Model model, Object objectValue) {
		return Base.getAll_Inverse_as(model, A_1.ROLE, objectValue, org.ontoware.rdf2go.model.node.Resource.class);
	}
