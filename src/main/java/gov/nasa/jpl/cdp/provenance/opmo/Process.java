...
public class Process extends Node {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@22652552 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@22652552 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public void removeAllEffectUsedInverse() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@66cf9bf0 has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@66cf9bf0 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
	...
	public void removeAllEffectWasControlledByInverse() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@4b07c76b has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@4b07c76b has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
	...
	public void removeAllEffectWasTriggeredByInverse() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@b06c6be has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@b06c6be has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
