...
public class WasTriggeredBy extends Edge {
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@3590efa8 has at least one value set 
     * @param model an RDF2Go model
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@3590efa8 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	...
	public void removeAllCauseWasTriggeredBy() {
     ...
     /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@51887dd5 has at least one value set 
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
     * @return true if this property has at least one value
	 *
    ...
    /**
     * Check if org.ontoware.rdfreactor.generator.java.JProperty@51887dd5 has the given value (maybe among other values).  
     * @param model an RDF2Go model
     * @param resource an RDF2Go resource
	 * @param value the value to be checked
     * @return true if this property contains (maybe among other) the given value
